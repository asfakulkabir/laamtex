...
@section('title', 'Add Slider Image - Outfitt')
...
<div class="max-w-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800/50 p-8 rounded-2xl shadow-lg">
    ...
    <div class="mb-6">
        <h3 class="font-bold text-white text-lg">New Slider Image</h3>
        <p class="text-sm text-slate-300 mt-1">Upload a hero slider image for the home page. Recommended size: <strong class="text-purple-400">1920 x 800 px</strong>.</p>
    </div>
    ...
    <form action="{{ route('admin.sliders.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
            <label for="image" class="block text-sm font-bold uppercase tracking-wider text-slate-300 mb-2">Image <span class="text-pink-500">*</span></label>
